...
export default class Details extends Component{
    render(){
        return(
            <ProductConsumer>
                {value =>{
                  const {id,company,img,info,infoo,inf,information,informas,price,title,inCart} =  value.detailProduct;
                  return(
